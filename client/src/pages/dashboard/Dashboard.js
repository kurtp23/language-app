...
import { Container, Divider, Grid, Header, Icon, Image, Button } from 'semantic-ui-react';
...
const Dashboard = () => (
  <Container style={{ margin: 0, paddingBottom: 0 }}>
    ...
    <Grid centered columns={1}>
      <Grid.Row only='mobile tablet'>
        <Grid.Column>
          ...
          >
            <Icon centered size={'mini'} name='globe' />
            Learnt-Up
          </Header>
        </Grid.Column>
      </Grid.Row>
    ...
    <Grid centered columns={2}>
      <Grid.Row>
        <Grid.Column computer={5} mobile={8} className='dash-container'>
          <Link to='translate'>
            <Button animated circular>
              <Button.Content visible>
                <Image
                  src='https://us.123rf.com/450wm/cienpies/cienpies1910/cienpies191000213/130889436-chat-bubbles-with-different-language-words-concept-illustration-for-translation-idea-or-internationa.jpg?ver=6'
                  size='massive'
                  circular
                />
              </Button.Content>
        ...
        <Grid.Column computer={5} mobile={8} className='dash-container'>
          <Link to='game'>
            <Button animated circular>
              <Button.Content visible>
                <Image
                  src='https://clipartstation.com/wp-content/uploads/2018/09/computer-game-clipart-8.jpg'
                  size='massive'
                  circular
                />
              </Button.Content>
        ...
        <Grid.Column computer={5} mobile={8} className='dash-container'>
          <Link to='settings'>
            <Button animated circular>
              <Button.Content visible>
                <Image
                  src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS10pF6Wa2KgcNPeCU6OXYkOSd3-87XJUM_AA&usqp=CAU'
                  size='massive'
                  circular
                />
              </Button.Content>
